...
[IMPORTANT]
Since Devkit version 3.8.0, all `@RestCall` annotations are deprecated. Please view https://docs.mulesoft.com/anypoint-connector-devkit/v/3.8/creating-a-connector-for-a-restful-api-using-jersey instead.
